...
<link href="css/home.css" rel="stylesheet" type="text/css">
    ...
    <div class="back_image">
        ...
        <div class="reg">
            ...
            <h3 style="margin-left: 100px; margin-bottom: -50px;margin-top: -15px;"></h3>
           
             <input name="voter_card_number"  placeholder="Enter your  Pin" type="text">
                         <h3 style="margin-top: -15px;margin-left: 100px;">pin has sent on your number : </h3>
